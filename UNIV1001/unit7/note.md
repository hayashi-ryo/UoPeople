...
1. テキストのアクティビティを実施したところ、個人の時間配分と理想の時間配分では10時間ほど理想の時間配分よりも余分な時間を過ごしていることがわかりました。自分に時間大きな影響を与える要素は、Working 、Sleeping、Personal hygiene、Time alone, Eating、Time aloneの順で、この要素だけで120時間ほどの時間を必要としています。workingとsleepingの時間は正直なところこれ以上減らすことはできないと考えているので、それ以外の時間について本当にその時間を費やすことが妥当なのか考える必要があります。
2. 私自身の時間の使い方から考えた時間管理の戦略を以下に記載します。
   1. より効率的に実施できる時間に実施する
      勉強や創作活動などの活動は適した時間に実施するとパフォーマンスが上がると言われています。また、単純作業などについても午後の時間など、パフォーマンスが落ちたタイミングでやること、個人のバイオニズムと活動のリズムを合わせることができます。
   2. それぞれの家事の時間を短縮する  
      料理の準備や入浴、掃除などの週30時間ほど時間を要していることが今回のアクティビテぃで認識しました。これは私が想定していたよりも大きな時間なのでぜひ対策を講じたいと考えていますたとえば以下のような内容です。
      1. 食事はまとめて作りおきする
      2. 家事ロボットを導入する
      3. 細かく実施することで、合計してかかる時間を少なくする
   3. 明日の予定を決めて行動してみる
      私自身の傾向として、決められた期限や予定のある行動は守る傾向があります。そのため、毎日寝る前に明日の予定を決めてみることで、明日の私はその予定に従って生活するだけで良い状況を作って見ようと思います。この予定を立てることで以下のようなメリットがあると考えています。
        自分が思っていた時間と実際にかかった時間のフィードバックが短いスパンで行える
        計画の中に個人時間を設けることで、無駄な時間を抑制する
